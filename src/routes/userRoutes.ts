...
userRouter.get("/id/:id", authAndRoleMiddleware(["user", "admin"]), userController.getUserById.bind(userController));
userRouter.get("/email/:email", authAndRoleMiddleware(["user", "admin"]), userController.getUserByEmail.bind(userController));
