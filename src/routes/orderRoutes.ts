...
orderRouter.post("/", authAndRoleMiddleware(["user"]), createOrderValidator, orderController.createOrder.bind(orderController));
...
orderRouter.patch("/:id", authAndRoleMiddleware(["user"]), updateOrderValidator, orderController.updateOrder.bind(orderController));
