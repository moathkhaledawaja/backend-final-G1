...
wishlistRouter.post("/", addProductToWishlist, wishlistController.addProductToWishlist.bind(wishlistController));
wishlistRouter.get("/", wishlistController.getWishList.bind(wishlistController));
wishlistRouter.delete("/:productId", addProductToWishlist, wishlistController.removeProductFromWishlist.bind(wishlistController));
